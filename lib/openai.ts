...
- NETRA Token: Our platform's reward token for user engagement
...
- Token NETRA: Token reward platform kami untuk engagement user
...
Response: "Pertanyaan bagus! Member premium mendapatkan respons AI yang lebih panjang, dukungan prioritas, dan analitik lanjutan..."`;
    ...
    const response = await openai.chat.completions.create({
      ...
      max_completion_tokens: isPremium ? 2048 : 512,
    });
