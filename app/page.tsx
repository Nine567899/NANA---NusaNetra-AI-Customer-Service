          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  href="/demo"
                  className="px-8 py-4 bg-gradient-to-r from-[#FFC0CB] to-[#D8A39D] text-white rounded-lg font-semibold hover-lift shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  {t.heroCtaDemo}
                </Link>
                <WalletMultiButton className="hover-lift" />
              </div>
            </div>
          </div>
        </section>
